            ...
            <div className="row">
                <div className="col-md-8 offset-md-2">
                    <ul className="timeline">
                        <li>
                            <a className="lead" target="_blank" rel="noopener noreferrer" href="https://www.eaciit.com/"><strong>Eaciit Ltd</strong></a>
                            <a className="float-right">2019</a>
                        ...
                        <li>
                            <a className="lead" target="_blank" rel="noopener noreferrer" href="https://www.bm.co.id">PT Bimasakti Multi Sinergi</a>
                            <a className="lead" className="float-right">2018</a>
                        ...
                        <li>
                            <a className="lead" target="_blank" rel="noopener noreferrer" href="https://www.bm.co.id">PT Bimasakti Multi Sinergi</a>
                            <a className="lead" className="float-right">2017</a>
                        ...
                        <li>
                            <a className="lead" target="_blank" rel="noopener noreferrer" href="http://www.triklin-rekatama.co.id">PT Triklin rekatama</a>
                            <a className="lead" className="float-right">2011</a>
